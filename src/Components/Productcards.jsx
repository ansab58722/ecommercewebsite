...
import {rawdata, addTocart,productselectedfeature} from "../features/CartSlice";
...
//seected color and size animation of product
  ...
  return (
    <div className="aa">
      <h1 className="producttitle" style={{color:"black"}}>Best Sellers in Footwears</h1>
...
dispatch(productselectedfeature(Product))
                  ...
                  <div className="shoe-details">
                    <span className="shoe_name"><a href="../Components/Productdetail.jsx">{Product.name} </a>  </span>
                 ...
                 dcolorandsize.size=document.querySelector(".size").attributes.value.value;
                  dcolorandsize.color=document.querySelector(".colour").attributes.value.value;
                      ...
                      const selectedproduct={
                        id: Product.id+dcolorandsize.color+dcolorandsize.size,
                         name:Product.name,
